...
Electrical Load Monitoring & Billing Simulator MID SEMESTER CAPSTONE PROJECT Name:Abednego Glover Elikem Student ID:01241576D 
Course: EEE 227 (PT) Programme: HND Electrical Engineering (Level 200) Development Environment: VS Code (Windows) Programming Language: C++ Data Storage: Text File using fstream
Project Overview
